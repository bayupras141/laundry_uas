            ...
            <div class="white-box">
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <strong>Total Pembayaran <?= rupiah($data['total_harga']) ?></strong><br>
                        <strong>Total Uang Bayar <?= rupiah($data['total_bayar']) ?></strong><br>
                        <strong>Kembalian <?= rupiah($data['total_bayar'] - $data['total_harga']) ?></strong><br><br>
                        <a href="transaksi_index.php" class="btn btn-primary">Kembali Ke Menu Utama</a>
                    </div>
                </div>
