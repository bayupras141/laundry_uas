...
$paket = ambildata($conn,'SELECT * FROM paket');
if(isset($_POST['btn-simpan'])){   
    $kode_invoice = $_POST['kode_invoice'];
    
    $query = "INSERT INTO transaksi (kode_invoice,member_id,tgl,batas_waktu,status,status_bayar,user_id) VALUES ('$kode_invoice','$member_id','$tgl_sekarang','$batas_waktu','baru','belum','$user_id')";
